...
public class TestSelenium21_MiniProject_3 {
    ...
    public void test_katalon_login() throws InterruptedException {
        ...
        // we are using list here bcoz with same xpath their are 2 elements located
        // and upon inspection we need 2nd one so used get(1) and for 1st element it could be get(0).
